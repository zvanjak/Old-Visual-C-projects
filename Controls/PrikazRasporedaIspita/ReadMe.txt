========================================================================
		ActiveX Control DLL : PRIKAZRASPOREDAISPITA
========================================================================

ControlWizard has created this project for your PRIKAZRASPOREDAISPITA ActiveX Control
...
PrikazRasporedaIspita.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
PrikazRasporedaIspita control:

PrikazRasporedaIspitaCtl.h
	This file contains the declaration of the CPrikazRasporedaIspitaCtrl C++ class.

PrikazRasporedaIspitaCtl.cpp
	This file contains the implementation of the CPrikazRasporedaIspitaCtrl C++ class.

PrikazRasporedaIspitaPpg.h
	This file contains the declaration of the CPrikazRasporedaIspitaPropPage C++ class.

PrikazRasporedaIspitaPpg.cpp
	This file contains the implementation of the CPrikazRasporedaIspitaPropPage C++ class.

PrikazRasporedaIspitaCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CPrikazRasporedaIspitaCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file PrikazRasporedaIspita.rc.
