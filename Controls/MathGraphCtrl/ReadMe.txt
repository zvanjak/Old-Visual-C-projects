========================================================================
		ActiveX Control DLL : MATHGRAPHCTRL
========================================================================

ControlWizard has created this project for your MATHGRAPHCTRL ActiveX Control
...
that make up your MATHGRAPHCTRL ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
MathGraphCtrl control:

MathGraphCtl.h
	This file contains the declaration of the CMathGraphCtrl C++ class.

MathGraphCtl.cpp
	This file contains the implementation of the CMathGraphCtrl C++ class.

MathGraphCtrlPpg.h
	This file contains the declaration of the CMathGraphCtrlPropPage C++ class.

MathGraphCtrlPpg.cpp
	This file contains the implementation of the CMathGraphCtrlPropPage C++ class.

MathGraphCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CMathGraphCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file MathGraphCtrl.rc.
