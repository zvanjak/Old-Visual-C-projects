========================================================================
		ActiveX Control DLL : GRAVITYSIMCONTROL
========================================================================

ControlWizard has created this project for your GRAVITYSIMCONTROL ActiveX Control
...
that make up your GRAVITYSIMCONTROL ActiveX Control DLL.

GravitySimControl.dsp
...
GravitySimControl.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
GravitySimCtrl control:

GravitySimCtl.h
	This file contains the declaration of the CGravitySimCtrl C++ class.

GravitySimCtl.cpp
	This file contains the implementation of the CGravitySimCtrl C++ class.

GravitySimCtrlPpg.h
	This file contains the declaration of the CGravitySimCtrlPropPage C++ class.

GravitySimCtrlPpg.cpp
	This file contains the implementation of the CGravitySimCtrlPropPage C++ class.

GravitySimCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CGravitySimCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file GravitySimControl.rc.

/////////////////////////////////////////////////////////////////////////////
Help Support:

GravitySimControl.hpj
