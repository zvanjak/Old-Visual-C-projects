========================================================================
		ActiveX Control DLL : CALCCONTROL
========================================================================

ControlWizard has created this project for your CALCCONTROL ActiveX Control
...
that make up your CALCCONTROL ActiveX Control DLL.
...
CalcControlCtl.h
	This file contains the declaration of the CCalcControlCtrl C++ class.

CalcControlCtl.cpp
	This file contains the implementation of the CCalcControlCtrl C++ class.

CalcControlPpg.h
	This file contains the declaration of the CCalcControlPropPage C++ class.

CalcControlPpg.cpp
	This file contains the implementation of the CCalcControlPropPage C++ class.

CalcControlCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CCalcControlCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file CalcControl.rc.
