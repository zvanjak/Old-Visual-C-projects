========================================================================
		ActiveX Control DLL : GRAPHCONTROL
========================================================================

ControlWizard has created this project for your GRAPHCONTROL ActiveX Control
...
that make up your GRAPHCONTROL ActiveX Control DLL.
...
GraphCtrl.h
	This file contains the declaration of the CGraphCtrl C++ class.

GraphCtrl.cpp
	This file contains the implementation of the CGraphCtrl C++ class.

GraphPpg.h
	This file contains the declaration of the CGraphPropPage C++ class.

GraphPpg.cpp
	This file contains the implementation of the CGraphPropPage C++ class.

GraphCtrl.bmp
	This file contains a bitmap that a container will use to represent the
	CGraphCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file GraphControl.rc.
