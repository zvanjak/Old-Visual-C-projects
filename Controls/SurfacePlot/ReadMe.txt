========================================================================
		ActiveX Control DLL : SURFACEPLOT
========================================================================

ControlWizard has created this project for your SURFACEPLOT ActiveX Control
...
that make up your SURFACEPLOT ActiveX Control DLL.
...
SurfacePlotCtl.h
	This file contains the declaration of the CSurfacePlotCtrl C++ class.

SurfacePlotCtl.cpp
	This file contains the implementation of the CSurfacePlotCtrl C++ class.

SurfacePlotPpg.h
	This file contains the declaration of the CSurfacePlotPropPage C++ class.

SurfacePlotPpg.cpp
	This file contains the implementation of the CSurfacePlotPropPage C++ class.

SurfacePlotCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CSurfacePlotCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file SurfacePlot.rc.
