...
void CSimpleGraph::ChangeGraphData(short GraphID, float* XValues, float* YValues, long PointsNum, LPCTSTR Legedn)
{
	static BYTE parms[] =
		VTS_I2 VTS_PR4 VTS_PR4 VTS_I4 VTS_BSTR;
	InvokeHelper(0x11, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 GraphID, XValues, YValues, PointsNum, Legedn);
}
